...
swap2Asm
    MOV R2, [R0]        // Dereference the address in R0, and copy contents to R2
    MOV R0, [R1]        // Deference the address of R1, and copy value into R0
...
swap2Asm
    MOV R0, [R0]        // Dereference address stored in R0 and copy value to R0
    MOV R2, R0          // Copy value of R0 into R2
    MOV R1, [R1]        // Dereference address stored in R1 and copy value to R1
    MOV R0, R1          // Copy of R1 value to R0
    MOV R1, R2          // Copy contents of R2 into R1
END
